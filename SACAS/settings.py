...
SECRET_KEY = 'django-insecure-woc_(9hf753icuxc_&%b$u8%0a=^18uaolkwwxou&v@l3&&n^+'
...
DATABASES = {
    'default': {
        'ENGINE': 'mssql',
        'NAME': 'SACAS',  # database name
        'HOST': r'DESKTOP-7EGFVFS\SQLEXPRESS',  # Server name
        'PORT': '',  
        'OPTIONS': {
...
STATIC_ROOT = os.path.join(BASE_DIR, 'static')  # Final collected static path
...
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'  # Ensure this is correct
